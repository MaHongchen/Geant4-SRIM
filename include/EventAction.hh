...
class EventAction : public G4UserEventAction
{
  public:
   ...
   ~EventAction() override;
    ...
    inline void AddNIEL_calculator(G4double Edep)    {fNIEL_calculator += Edep;};
    inline void AddNIEL_step(G4double val) { fNIEL_step += val; };
    inline G4double GetEnergyDeposit()    {return fTotalEnergyDeposit;};
    
  private:
    G4double fTotalEnergyDeposit;
    G4double fNIEL_calculator, fNIEL_step;
};
